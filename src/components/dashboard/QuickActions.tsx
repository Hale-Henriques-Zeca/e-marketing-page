...
export default function QuickActions() {
  return (
    <section className="rounded-3xl bg-[#E11D8A] border border-white/10 p-5">
      <div className="text-sm font-semibold">Acesso rápido</div>

      <div className="mt-4 grid grid-cols-4 gap-4">
        {actions.map((a) => (
          <Link key={a.label} href={a.href} className="group text-center">
            <div className="mx-auto h-16 w-16 rounded-full bg-[#1FA971] border border-white/10 grid place-items-center group-hover:bg-white/10 transition">
